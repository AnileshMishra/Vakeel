...
class BusinessClassTest {
	...
	public void getDistrictlist_test() throws ParseException {
		...
		Timestamp createdTime = new Timestamp(((Date) ft.parse("04-08-2024")).getTime());
...
//		expectedDto.setStatusCode(200);
//		expectedDto.setStatusMsg("Success.");
//		expectedDto.setResponseMsg("Record found successfully!!!.");
